...
class WeightCalculator:
    ...
    @staticmethod
    def _calculate_raw_weights(diary: Dict[str, Any], now: datetime, selection_type: str) -> Dict[str, float]:
        """
        计算单个日记的原始权重
    ...
    def calculate_selection_weights(
        ...
        for diary in diaries:
            raw_weights = WeightCalculator._calculate_raw_weights(diary, now, selection_type)
